...
const ForFamilyForm: FC<Props> = ({ price }): JSX.Element => {
      ...
      <>
        <div className="relative">
          <FormInput
            ...
            labelCustomClasses="!mb-2 block !text-xs !font-semibold !text-[#337ab7]"
          />
          <div className="absolute left-4 top-9 cursor-pointer text-[#666]">
            <ImUser size={20} />
          </div>
        </div>
