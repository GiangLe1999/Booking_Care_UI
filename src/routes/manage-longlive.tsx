...
import { createNewLonglive } from "../service/longlive.service";
...
const ManageLonglive: FC<Props> = (props): JSX.Element => {
  ...
  const onSubmit = async (FormData: FormValues) => {
    try {
      ...
      const data = await createNewLonglive({
      ...
      setIsLoading(false);
      toast.success("Tạo bài viết sống khỏe thành công");
    } catch (error: any) {
      setIsLoading(false);
    ...
    <AdminProtectedPage>
      <div className="admin-page-container">
        <h1 className="admin-page-title">
          <FormattedMessage id="manage-longlive.title" />
        </h1>
