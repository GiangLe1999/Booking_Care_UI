...
import { createNewHandbook } from "../service/handbook.service";
...
const ManageHanbook: FC<Props> = (props): JSX.Element => {
  ...
  const onSubmit = async (FormData: FormValues) => {
    try {
      ...
      const data = await createNewHandbook({
      ...
      setIsLoading(false);
      toast.success("Tạo bài viết cẩm nang thành công");
    } catch (error: any) {
      setIsLoading(false);
